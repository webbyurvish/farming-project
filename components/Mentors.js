...
export default function ({ categoryId }) {
  ...
  return (
    <>
      <div
        className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover bg-fixed"
        style={{
          backgroundImage:
      ...
      >
        {data &&
          data.map((mentor) => {
            return (
              <>
                <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 lg:mb-[-6rem]">
                  <div
                    id="profile"
                  ...
                  >
                    <div className="p-4 md:p-12 text-center lg:text-left">
                      ...
                      <p className="pt-8 text-sm">{mentor.description}</p>
